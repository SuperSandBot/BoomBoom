...
public class ImageManeger {
    ...
    public ImageManeger()
    {
        goldcoin = new Image(getClass().getResourceAsStream("/Game/Asset/Item/goldcoin.png"));
        boomupgrade = new Image(getClass().getResourceAsStream("/Game/Asset/Item/boomupgrade.png"));
        boot = new Image(getClass().getResourceAsStream("/Game/Asset/Item/boot.png"));
        vile = new Image(getClass().getResourceAsStream("/Game/Asset/Item/vile.png"));
        shadow = new Image(getClass().getResourceAsStream("/Game/Asset/Item/shadow.png"));
        ...
        splashBodyVertical = new Image(getClass().getResourceAsStream("/Game/Asset/Boom/splashBodyVertical.png"));
        splashBodyHorizontal = new Image(getClass().getResourceAsStream("/Game/Asset/Boom/splashBodyHorizontal.png"));
        splashEndTop = new Image(getClass().getResourceAsStream("/Game/Asset/Boom/splashEndTop.png"));
        splashEndDown = new Image(getClass().getResourceAsStream("/Game/Asset/Boom/splashEndDown.png"));
        splashEndLeft = new Image(getClass().getResourceAsStream("/Game/Asset/Boom/splashEndLeft.png"));
        splashEndRight = new Image(getClass().getResourceAsStream("/Game/Asset/Boom/splashEndRight.png"));

        dirtBlock00 = new Image(getClass().getResourceAsStream("/Game/Asset/Block/DirtBlock00.png"));
        dirtBlock01 = new Image(getClass().getResourceAsStream("/Game/Asset/Block/DirtBlock01.png"));
        grassBlock = new Image(getClass().getResourceAsStream("/Game/Asset/Block/grassblock.png"));
        stoneBlock = new Image(getClass().getResourceAsStream("/Game/Asset/Block/stone.png"));
    }
