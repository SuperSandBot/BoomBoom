...
public class GameHandler extends Parent implements Runnable {
    ...
    public void setup()
    {
        ...
        imageGS = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/GameStart.png")));
        imageGO = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/GameOver.png")));
        scorePanel = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/panel.png")));
        imageUI = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/TimerUI.png")));
        player1score = new ImageView( new Image(getClass().getResourceAsStream("/application/Asset/UI/player1score.png")));
        player2score = new ImageView( new Image(getClass().getResourceAsStream("/application/Asset/UI/player2score.png")));
        btnimage = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/retry_button.png")));
        btnimagemainmenu = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/mainmenu_btn.png")));
        btnImageContinue = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/continue_btn.png")));
        blackScreen = new ImageView(new Image(getClass().getResourceAsStream("/application/Asset/UI/black_sceen.png")));
    ...
    private void GameStartAnimation()
    {
        ...
        switch(i)
        {
            ...
            case 0:
                ...
                gs.playAudio(GameSound.GAMESTARTSOUND);
                i = -1;
                break;
            default:
                break;
    ...
    private void Tic()
    {
        ...
        if(GameStartAnimation)
        {
            if(i == -1)
            {
                ...
                gs.playOnBackGround(GameSound.GAMEPLAY);
                gs.backGroundMusic.setVolume(0.5);
            }
            else
            {
            	i--;
    ...
    private void EndGame()
    {
        ...
        gs.playAudio(GameSound.GAMEOVER);
        GameOverAnimation();
    }
